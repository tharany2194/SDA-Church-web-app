...
import { Play, MapPin, ChevronRight, Instagram, Facebook, Youtube } from 'lucide-react';
...
export default function HeroSection() {
  ...
  const content = {
    en: {
      location: 'Varadharajapuram,Poonamallee, Tamil Nadu',
      ...
      >
        ...
        <div className="relative z-10 flex-grow md:h-full flex flex-col md:flex-row items-center md:items-end justify-between px-4 sm:px-6 md:px-10 lg:px-14 pb-6 md:pb-8 lg:pb-10 pt-6 sm:pt-8">
          ...
          <div className="w-full md:w-3/5 lg:w-1/2 text-center md:text-left flex flex-col justify-center md:justify-end flex-grow md:flex-grow-0 md:h-auto mb-6 md:mb-0">
            ...
            {/* Location badge */}
            <div className="block mb-2 sm:mb-3 self-center md:self-start text-center md:text-left">
              <span className="text-white/70 text-[10px] sm:text-[12.5px] font-bold tracking-widest uppercase leading-snug">
                {language === 'en' ? (
                  <>
                    <MapPin size={11} className="inline-block text-white/70 mr-2 sm:mr-3 md:mr-4 mb-[2px]" />
                    Varadharajapuram, Poonamallee,
                    <br className="block sm:hidden" />
                    <span className="hidden sm:inline"> </span>Tamil Nadu
                  </>
                ) : (
                  <>
                    <MapPin size={11} className="inline-block text-white/70 mr-2 sm:mr-3 md:mr-4 mb-[2px]" />
